...
# already!
CREDENTIALS_FILE="$HOME/AppData/Roaming/terraform.d/credentials.tfrc.json" # changed path
...
echo
echo "This script will set up fakewebservices within your organization and workspace - in less than a minute."
echo
